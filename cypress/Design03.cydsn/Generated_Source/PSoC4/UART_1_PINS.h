...
***************************************/
    ...
    #define UART_1_SCLK_HSIOM_SEL_GPIO  (UART_1_spi_sclk__0__HSIOM_GPIO)
    #define UART_1_SCLK_HSIOM_SEL_I2C   (UART_1_spi_sclk__0__HSIOM_I2C)
    #define UART_1_SCLK_HSIOM_SEL_SPI   (UART_1_spi_sclk__0__HSIOM_SPI)
    #define UART_1_SCLK_HSIOM_SEL_UART  (UART_1_spi_sclk__0__HSIOM_UART)
    ...
    #define UART_1_SS0_HSIOM_SEL_GPIO  (UART_1_spi_ss0__0__HSIOM_GPIO)
    #define UART_1_SS0_HSIOM_SEL_I2C   (UART_1_spi_ss0__0__HSIOM_I2C)
    #define UART_1_SS0_HSIOM_SEL_SPI   (UART_1_spi_ss0__0__HSIOM_SPI)
#if !(UART_1_CY_SCBIP_V0 || UART_1_CY_SCBIP_V1)
    #define UART_1_SS0_HSIOM_SEL_UART  (UART_1_spi_ss0__0__HSIOM_UART)
