...
static void AnalogSetDefault(void)
{
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x000000BDu);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x000000BDu);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_PRT0_PC), 0x00492492u);

	/* IOPINS0_1 Starting address: CYDEV_PRT1_BASE */
	CY_SET_XTND_REG32((void CYFAR *)(CYDEV_PRT1_BASE), 0x0000003Fu);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_PRT1_PC), 0x00192492u);

	/* IOPINS0_2 Starting address: CYDEV_PRT2_BASE */
	CY_SET_XTND_REG32((void CYFAR *)(CYDEV_PRT2_BASE), 0x000000BDu);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_PRT2_PC2), 0x000000BDu);
